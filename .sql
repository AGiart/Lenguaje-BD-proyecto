...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINPBIBLIOTECA"."EDITORIALES_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINPBIBLIOTECA"."LIBROS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 121 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINPBIBLIOTECA"."MULTAS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PRESTAMO_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ADMINPBIBLIOTECA"."PRESTAMO_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ADMINPBIBLIOTECA"."SEQ_MULTA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 71 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.AUTORES (AUTORID,NOMBREAUTOR,APELLIDOAUTOR,NACIONALIDADID) values ('6','Jason','Jason','3');
...
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('21','Maestra');
Insert into ADMINPBIBLIOTECA.EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('6','cARS');
Insert into ADMINPBIBLIOTECA.EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('7','uNIVERSALdUM');
Insert into ADMINPBIBLIOTECA.EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('1','Planeta');
Insert into ADMINPBIBLIOTECA.EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('2','Diana');
Insert into ADMINPBIBLIOTECA.EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('3','Secker ');
...
Insert into ADMINPBIBLIOTECA.GENEROS (GENREID,NOMBREGENERO) values ('41','Thriller');
...
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.LIBROS (BOOKID,TITULO,AUTORID,GENEROID,EDITORIALID,IDIOMAID,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES) values ('101','Hunger Games','3','3','1','2','2002','12313','12');
Insert into ADMINPBIBLIOTECA.LIBROS (BOOKID,TITULO,AUTORID,GENEROID,EDITORIALID,IDIOMAID,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES) values ('84','Harry Potter','3','2','2','1','1974','21312','23');
REM INSERTING into ADMINPBIBLIOTECA.MULTAS
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('62','4','2','1500',to_date('02-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('63','4','2','1500',to_date('02-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('64','4','2','1500',to_date('02-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('65','4','2','1500',to_date('02-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('66','4','2','1500',to_date('02-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('69','4','2','1500',to_date('04-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('70','6','2','1500',to_date('04-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('67','4','2','1500',to_date('03-DIC-23','DD-MON-RR'),'Pendiente');
Insert into ADMINPBIBLIOTECA.MULTAS (MULTAID,PRESTAMOID,USUARIOCEDULA,MONTO,FECHACREACION,ESTADO) values ('68','6','2','1500',to_date('03-DIC-23','DD-MON-RR'),'Pendiente');
...
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('4',to_date('02-DIC-23','DD-MON-RR'),to_date('01-DIC-23','DD-MON-RR'),'2','84');
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('5',to_date('02-DIC-23','DD-MON-RR'),to_date('15-DIC-23','DD-MON-RR'),'2','84');
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('6',to_date('02-DIC-23','DD-MON-RR'),to_date('03-DIC-23','DD-MON-RR'),'2','84');
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('7',to_date('02-DIC-23','DD-MON-RR'),to_date('23-DIC-23','DD-MON-RR'),'2','84');
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('1',to_date('01-DIC-23','DD-MON-RR'),to_date('15-DIC-23','DD-MON-RR'),'1','84');
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('2',to_date('02-DIC-23','DD-MON-RR'),to_date('16-DIC-23','DD-MON-RR'),'2','84');
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('3',to_date('03-DIC-23','DD-MON-RR'),to_date('17-DIC-23','DD-MON-RR'),'1','84');
Insert into ADMINPBIBLIOTECA.PRESTAMO (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,USUARIOCEDULA,LIBROID) values ('8',to_date('03-DIC-23','DD-MON-RR'),to_date('16-DIC-23','DD-MON-RR'),'2','84');
...
Insert into ADMINPBIBLIOTECA.USUARIOS (CEDULA,NOMBRE,APELLIDO,EMAIL,CONTRASENA,ROLID) values ('123','Jason','Jason','jimenezjason35@gmail.com','123','1');
Insert into ADMINPBIBLIOTECA.USUARIOS (CEDULA,NOMBRE,APELLIDO,EMAIL,CONTRASENA,ROLID) values ('22','Jason','Jason','jimenezcarjason35@gmail.com','123','2');
REM INSERTING into ADMINPBIBLIOTECA.V_AUTORES
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.V_AUTORES (AUTORID,NOMBREAUTOR,APELLIDOAUTOR,NACIONALIDADID) values ('6','Jason','Jason','3');
...
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.V_EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('21','Maestra');
Insert into ADMINPBIBLIOTECA.V_EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('6','cARS');
Insert into ADMINPBIBLIOTECA.V_EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('7','uNIVERSALdUM');
Insert into ADMINPBIBLIOTECA.V_EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('1','Planeta');
Insert into ADMINPBIBLIOTECA.V_EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('2','Diana');
Insert into ADMINPBIBLIOTECA.V_EDITORIALES (PUBLISHERID,NOMBREEDITORIAL) values ('3','Secker ');
...
Insert into ADMINPBIBLIOTECA.V_GENEROS (GENREID,NOMBREGENERO) values ('41','Thriller');
...
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.VISTALIBROS (BOOKID,TITULO,NOMBRECOMPLETOAUTOR,NOMBREGENERO,NOMBREEDITORIAL,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES) values ('101','Hunger Games','George Orwell','Distopía','Planeta','2002','12313','12');
Insert into ADMINPBIBLIOTECA.VISTALIBROS (BOOKID,TITULO,NOMBRECOMPLETOAUTOR,NOMBREGENERO,NOMBREEDITORIAL,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES) values ('84','Harry Potter','George Orwell','Realismo mágico','Diana','1974','21312','23');
REM INSERTING into ADMINPBIBLIOTECA.VISTALIBROSPORGENERO
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.VISTALIBROSPORGENERO (BOOKID,TITULO,AUTORID,GENEROID,EDITORIALID,IDIOMAID,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES,NOMBREGENERO) values ('101','Hunger Games','3','3','1','2','2002','12313','12','Distopía');
Insert into ADMINPBIBLIOTECA.VISTALIBROSPORGENERO (BOOKID,TITULO,AUTORID,GENEROID,EDITORIALID,IDIOMAID,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES,NOMBREGENERO) values ('84','Harry Potter','3','2','2','1','1974','21312','23','Realismo mágico');
REM INSERTING into ADMINPBIBLIOTECA.VISTAPRESTAMOS
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('1',to_date('01-DIC-23','DD-MON-RR'),to_date('15-DIC-23','DD-MON-RR'),'Admin','84','Harry Potter');
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('3',to_date('03-DIC-23','DD-MON-RR'),to_date('17-DIC-23','DD-MON-RR'),'Admin','84','Harry Potter');
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('4',to_date('02-DIC-23','DD-MON-RR'),to_date('01-DIC-23','DD-MON-RR'),'Staff','84','Harry Potter');
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('5',to_date('02-DIC-23','DD-MON-RR'),to_date('15-DIC-23','DD-MON-RR'),'Staff','84','Harry Potter');
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('6',to_date('02-DIC-23','DD-MON-RR'),to_date('03-DIC-23','DD-MON-RR'),'Staff','84','Harry Potter');
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('7',to_date('02-DIC-23','DD-MON-RR'),to_date('23-DIC-23','DD-MON-RR'),'Staff','84','Harry Potter');
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('2',to_date('02-DIC-23','DD-MON-RR'),to_date('16-DIC-23','DD-MON-RR'),'Staff','84','Harry Potter');
Insert into ADMINPBIBLIOTECA.VISTAPRESTAMOS (PRESTAMOID,FECHAPRESTAMO,FECHADEVOLUCION,NOMBREUSUARIO,LIBROID,TITULOLIBRO) values ('8',to_date('03-DIC-23','DD-MON-RR'),to_date('16-DIC-23','DD-MON-RR'),'Staff','84','Harry Potter');
...
SET DEFINE OFF;
Insert into ADMINPBIBLIOTECA.V_LIBROS (BOOKID,TITULO,AUTORID,GENEROID,EDITORIALID,IDIOMAID,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES) values ('101','Hunger Games','3','3','1','2','2002','12313','12');
Insert into ADMINPBIBLIOTECA.V_LIBROS (BOOKID,TITULO,AUTORID,GENEROID,EDITORIALID,IDIOMAID,ANIOPUBLICACION,ISBN,CANTIDADCOPIASDISPONIBLES) values ('84','Harry Potter','3','2','2','1','1974','21312','23');
...
/
--------------------------------------------------------
--  DDL for Procedure BUSCAUSER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "ADMINPBIBLIOTECA"."BUSCAUSER" (id_USER NUMBER)
IS
  bNombre VARCHAR2(999);
  bApellido VARCHAR2(999);
  bEmail VARCHAR2(999);
  cuenta NUMBER;
  i NUMBER;
BEGIN
    i := id_USER;
    SELECT COUNT(*) INTO cuenta FROM Usuarios;
    FOR i IN 1..cuenta LOOP        
        SELECT i||'.'||Nombre || '   ' || bNombre || '   '  INTO bNombre FROM Usuarios WHERE UserID = i;
        SELECT i||'.'||Apellido || '   ' || bApellido || '   '  INTO bApellido FROM Usuarios WHERE UserID = i;
        SELECT i||'.'||Email || '   ' || bEmail || '   '  INTO bEmail FROM Usuarios WHERE UserID = i;
    END LOOP;
    DBMS_OUTPUT.PUT_LINE('Nombres: '||bNombre);
    DBMS_OUTPUT.PUT_LINE('Apellidos: '||bApellido);
    DBMS_OUTPUT.PUT_LINE('Emails: '||bEmail);
EXCEPTION 
   WHEN NO_DATA_FOUND 
   THEN 
      DBMS_OUTPUT.PUT_LINE ('NO EXISTE EL USUARIO CON EL ID '||id_USER);
END;

/
--------------------------------------------------------
--  DDL for Procedure EDITAUSER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "ADMINPBIBLIOTECA"."EDITAUSER" (eUserID NUMBER,
    eNombre VARCHAR2,
    eApellido VARCHAR2,
    eEmail VARCHAR2)
AS
BEGIN
    UPDATE Usuarios SET Nombre= eNombre, Apellido= eApellido, Email= eEmail WHERE UserID = eUserID;
    DBMS_OUTPUT.PUT_LINE('Usuario actualizado');
EXCEPTION 
   WHEN NO_DATA_FOUND
   THEN 
      DBMS_OUTPUT.PUT_LINE ('NO EXISTE EL USUARIO CON EL ID '||eUserID);
END;
...
/
--------------------------------------------------------
--  DDL for Procedure ELIMINAUSER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "ADMINPBIBLIOTECA"."ELIMINAUSER" (dUserID NUMBER)
AS
BEGIN
    DELETE FROM Usuarios WHERE UserID = dUserID;
    DBMS_OUTPUT.PUT_LINE('Usuario eliminado');
EXCEPTION 
   WHEN NO_DATA_FOUND
   THEN 
      DBMS_OUTPUT.PUT_LINE ('NO EXISTE EL USUARIO CON EL ID '||dUserID);
END;
...
/
--------------------------------------------------------
--  DDL for Procedure INSERTAUSER
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "ADMINPBIBLIOTECA"."INSERTAUSER" (iUserID NUMBER,
    iNombre VARCHAR2,
    iApellido VARCHAR2,
    iEmail VARCHAR2)
AS
BEGIN
    INSERT INTO Usuarios (UserID, Nombre, Apellido, Email) VALUES (iUserID, iNombre, iApellido, iEmail);
...
/
--------------------------------------------------------
--  DDL for Function INICIARSESIONYOBTENERUSUARIO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "ADMINPBIBLIOTECA"."INICIARSESIONYOBTENERUSUARIO" (
    p_cedula IN NUMBER,
    p_contrasena IN VARCHAR2
...
BEGIN
    -- Verificar el inicio de sesión
    v_usuario_encontrado := UsuarioFunction(p_cedula, p_contrasena);

    -- Si se encuentra el usuario, obtener sus datos
    IF v_usuario_encontrado = 1 THEN
        OPEN v_cursor FOR
            SELECT *
            FROM usuarios
            WHERE CEDULA = p_cedula;
        RETURN v_cursor;
    ELSE
        -- Devolver un cursor vacío si no se encuentra el usuario
        OPEN v_cursor FOR
            SELECT NULL
            FROM DUAL
            WHERE 1 = 0;
...
/
--------------------------------------------------------
--  DDL for Function REGISTRAR_MULTA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE FUNCTION "ADMINPBIBLIOTECA"."REGISTRAR_MULTA" (
    p_prestamo_id NUMBER,
    p_monto NUMBER,
    p_fecha_pago DATE
) RETURN NUMBER
AS
    v_multa_id NUMBER;
BEGIN
    INSERT INTO multas (FINEID, AMOUNT, FECHAPAGO)
    VALUES (p_prestamo_id, p_monto, p_fecha_pago)
    RETURNING FINEID INTO v_multa_id;
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMINPBIBLIOTECA"."AUTORES" ADD FOREIGN KEY ("NACIONALIDADID")
	  REFERENCES "ADMINPBIBLIOTECA"."NACIONALIDADES" ("NACIONALIDADID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LIBROS
--------------------------------------------------------

  ALTER TABLE "ADMINPBIBLIOTECA"."LIBROS" ADD FOREIGN KEY ("AUTORID")
	  REFERENCES "ADMINPBIBLIOTECA"."AUTORES" ("AUTORID") ENABLE;
  ALTER TABLE "ADMINPBIBLIOTECA"."LIBROS" ADD FOREIGN KEY ("GENEROID")
	  REFERENCES "ADMINPBIBLIOTECA"."GENEROS" ("GENREID") ENABLE;
  ALTER TABLE "ADMINPBIBLIOTECA"."LIBROS" ADD FOREIGN KEY ("EDITORIALID")
	  REFERENCES "ADMINPBIBLIOTECA"."EDITORIALES" ("PUBLISHERID") ENABLE;
  ALTER TABLE "ADMINPBIBLIOTECA"."LIBROS" ADD FOREIGN KEY ("IDIOMAID")
	  REFERENCES "ADMINPBIBLIOTECA"."IDIOMAS" ("LANGUAGEID") ENABLE;
--------------------------------------------------------
